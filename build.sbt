...
homepage := Some(url("https://github.com/scalajs-io/redis"))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/redis</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/redis.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/redis.git</developerConnection>
        <url>github.com/scalajs-io/redis.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
